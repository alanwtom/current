...
print ""
print "  Then bump the Homebrew cask to $VERSION and that same SHA-256 — both"
print "  packaging/current.rb here and Casks/current.rb in alanwtom/homebrew-tap,"
print "  which is the one brew installs from. This is on the list because it was"
print "  forgotten once: 1.2.0 shipped with the cask still on 1.1.1, so a fresh"
print "  'brew install --cask' handed people the previous version."
print ""
print "  And close the changelog links: point [Unreleased] at $TAG and add a"
print "  [$VERSION] line, or the heading you just wrote links nowhere."
print ""
